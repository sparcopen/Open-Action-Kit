## September
Have you decided how you'll be taking action for Open Acess Week?  If not, no worries!  Some of us are just getting started too, so we've complied some materials to help you **choose your action and create a plan**.  Stayed tuned, because later this month we'll be publishing tools to help you connect your OA Week actions with your institution's priorities, and refine your talking points.
...
The Open Action Kit quiz, checklists, and timeline were desiged by [Camille Thomas, Texas Tech University Libraries](https://twitter.com/afrofuturistlib).  This work is licensed under a Creative Commons Attribution-NonCommercial 4.0 International License
